...
export default class UserController {
  ...
  async findAll(req: Request, res: Response) {
    const name = typeof req.query.title === "string" ? req.query.title : "";
    const email =
      typeof req.query.published === "string" ? req.query.published : "";

    try {
      const users = await userRepository.retrieveAll({ name, email });
